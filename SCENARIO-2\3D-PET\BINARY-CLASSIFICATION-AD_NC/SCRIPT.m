...
layers = [...
    ...
    fullyConnectedLayer(100,"Name","fc_1",'WeightL2Factor', 0.00005, 'BiasL2Factor', 0.00005)
    fullyConnectedLayer(30,"Name","fc_2",'WeightL2Factor', 0.00005, 'BiasL2Factor', 0.00005)
